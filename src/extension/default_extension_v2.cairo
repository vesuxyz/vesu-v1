...
use vesu::{
    ...
    extension::{
        ...
        default_extension::{FeeParams, ShutdownParams, LiquidationParams, VTokenParams}
    }
};
...
#[starknet::interface]
trait IDefaultExtensionV2<TContractState> {
...
mod DefaultExtensionV2 {
    ...
    use vesu::{
        ...
        extension::{
            ...
            default_extension_v2::{IDefaultExtensionV2, ChainlinkOracleParams}, interface::{IExtension},
            components::{
                interest_rate_model::{
    ...
    #[abi(embed_v0)]
    impl DefaultExtensionV2Impl of IDefaultExtensionV2<ContractState> {
