...
mod TestAssetRetrieval {
    ...
    fn test_retrieve_from_reserve_total_balance() {
        ...
        assert!(post_retrieval_user_balance == initial_lender_debt_asset_balance, "Asset not transferred to the user");
    ...
    fn test_retrieve_from_reserve_partial_balance() {
        ...
        let asset_config_pre_retrieval = singleton.asset_configs(pool_id, debt_asset.contract_address);
