...
mod TestPoolDonation {
    ...
    fn test_donate_to_reserve_pool() {
        ...
        let old_pool_reserve = singleton.asset_config(pool_id, debt_asset.contract_address).reserve;
        ...
        let new_pool_reserve = singleton.asset_config(pool_id, debt_asset.contract_address).reserve;
