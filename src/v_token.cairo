...
mod VToken {
    ...
    fn calculate_withdrawalable_assets(asset_config: AssetConfig, total_debt: u256) -> u256 {
    ...
    impl InternalFunctions of InternalFunctionsTrait {
        ...
        /// See the `calculate_withdrawalable_assets`.
        fn calculate_withdrawalable_assets(self: @ContractState, asset_config: AssetConfig) -> u256 {
            let total_debt = self
                .singleton()
                .calculate_debt(
                    asset_config.total_nominal_debt.into(), asset_config.last_rate_accumulator, asset_config.scale
                );
            calculate_withdrawalable_assets(asset_config, total_debt)
        }
    ...
    impl VToken of super::IVToken<ContractState> {
        /// Returns the extension associated with the vToken
        /// # Returns
        ...
        /// Reapproves the vToken to be spendable by the extension
    ...
    impl IERC4626 of super::IERC4626<ContractState> {
        ...
        fn total_assets(self: @ContractState) -> u256 {
            self
                .singleton()
                .calculate_collateral(self.pool_id.read(), self.asset.read(), -self.erc20.total_supply().into())
        }
        ...
        fn convert_to_shares(self: @ContractState, assets: u256) -> u256 {
            self.singleton().calculate_collateral_shares(self.pool_id.read(), self.asset.read(), assets.into())
        }
        ...
        fn convert_to_assets(self: @ContractState, shares: u256) -> u256 {
            self.singleton().calculate_collateral(self.pool_id.read(), self.asset.read(), -shares.into())
        }
        ...
        fn max_deposit(self: @ContractState, receiver: ContractAddress) -> u256 {
            ...
            self.singleton().calculate_collateral(self.pool_id.read(), self.asset.read(), room.into())
        }
        ...
        fn deposit(ref self: ContractState, assets: u256, receiver: ContractAddress) -> u256 {
            ...
            let params = ModifyPositionParams {
                ...
                collateral: Amount {
                    amount_type: AmountType::Delta, denomination: AmountDenomination::Assets, value: assets.into(),
                },
        ...
        fn mint(ref self: ContractState, shares: u256, receiver: ContractAddress) -> u256 {
            let assets_estimate = self
                .singleton()
                .calculate_collateral(self.pool_id.read(), self.asset.read(), shares.into());
            ...
            let params = ModifyPositionParams {
                ...
                user: self.extension.read(),
                collateral: Amount {
                    amount_type: AmountType::Delta, denomination: AmountDenomination::Native, value: shares.into(),
                },
                debt: Default::default(),
                data: ArrayTrait::new().span()
            };
            ...
            assert!(assets == assets_estimate, "wrong-estimate");
        ...
        fn max_withdraw(self: @ContractState, owner: ContractAddress) -> u256 {
            ...
            let room = self.calculate_withdrawalable_assets(asset_config);
            let assets = self
                .singleton()
                .calculate_collateral(self.pool_id.read(), self.asset.read(), -self.erc20.balance_of(owner).into());
        ...
        fn max_redeem(self: @ContractState, owner: ContractAddress) -> u256 {
            ...
            let room = self
                ...
                .calculate_collateral_shares(
                    self.pool_id.read(), self.asset.read(), self.calculate_withdrawalable_assets(asset_config).into()
                );
