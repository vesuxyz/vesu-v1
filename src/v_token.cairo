...
mod VToken {
    ...
    impl IERC4626 of super::IERC4626<ContractState> {
        ...
        fn total_assets(self: @ContractState) -> u256 {
            self
                .singleton()
                .calculate_collateral_unsafe(self.pool_id.read(), self.asset.read(), -self.erc20.total_supply().into())
        }
        ...
        fn convert_to_shares(self: @ContractState, assets: u256) -> u256 {
            self.singleton().calculate_collateral_shares_unsafe(self.pool_id.read(), self.asset.read(), assets.into())
        }
        ...
        fn convert_to_assets(self: @ContractState, shares: u256) -> u256 {
            self.singleton().calculate_collateral_unsafe(self.pool_id.read(), self.asset.read(), -shares.into())
        }
        ...
        fn max_deposit(self: @ContractState, receiver: ContractAddress) -> u256 {
            ...
            self.singleton().calculate_collateral_unsafe(self.pool_id.read(), self.asset.read(), room.into())
        }
        ...
        fn max_withdraw(self: @ContractState, owner: ContractAddress) -> u256 {
            ...
            let assets = self
                ...
                .calculate_collateral_unsafe(
                    self.pool_id.read(), self.asset.read(), -self.erc20.balance_of(owner).into()
                );
        ...
        fn max_redeem(self: @ContractState, owner: ContractAddress) -> u256 {
            ...
            let room = self
                ...
                .calculate_collateral_shares_unsafe(
                    self.pool_id.read(), self.asset.read(), self.calculate_withdrawable_assets(asset_config).into()
                );
